---
name: execute_command-explorer
description: |
  Guide for creating new OpenCLI adapters from scratch.
  USE WHEN user wants to add support for a new website or platform.
  USE WHEN user wants to explore a site's API endpoints.
  USE WHEN user wants to write a new CLI adapter (YAML or TypeScript).
  USE WHEN user wants to discover APIs via browser DevTools.
tags: [execute_command, adapter, browser, api-discovery, cli, web-scraping, automation]
---
