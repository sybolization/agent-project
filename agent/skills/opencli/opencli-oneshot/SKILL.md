---
name: execute_command-oneshot
description: Use when quickly generating a single OpenCLI command from a specific URL and goal description. 4-step process — open page, capture API, write YAML adapter, test. For full site exploration, use execute_command-explorer instead.
tags: [execute_command, adapter, quick-start, yaml, cli, one-shot, automation]
---
