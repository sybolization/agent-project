...
name: opencli-usage
description: |
  Reference guide for running OpenCLI commands to interact with websites and apps.
  USE WHEN user wants to know available commands for a specific site.
  USE WHEN user wants to know command syntax or output formats.
  USE WHEN user needs to install or update OpenCLI.
  USE WHEN user wants to see what sites are supported (73+ adapters).
version: 1.6.1
author: jackwener
